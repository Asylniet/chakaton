...
export const locations: TLocation[] = [
    {
        ...
        overview: <div className="mr-3">
            <p className="mb-2">
                <span className="font-bold">Мечеть Аль-Харам</span> - Первая мечеть на земле. Первый храм Единому Богу, установленный Адамом и
            ...
            <div className="bg-[#74c365] text-white rounded-[10px] mt-4">
                <p className="text-center font-bold text-[24px] pt-4 pb-4">Интересные факты</p>
        ...
        amal: <>
            <ContextLink content={
                <>
                    <div className="flex gap-2 p-[5px] rounded-[15px]">
                        <div>
                            <p className="text-center font-bold text-[24px] mb-2">Действия при входе в мечеть Аль-Харам</p>
                            <p className="ml-6 mt-2 text-[16px]">
                                ...
                                <p className="mb-2">
                                    6) Молитва перевод: &quot;Я прошу защиты Великим Аллахом и Его прекрасной сущностью, Его
                                    изначальным
            ...
            } triggerClassname='text-[16px] text-[#09090B] no-underline'>
                <div>
                    <img className="rounded-[15px] w-[100%] mx-auto" src='/al-haram-how-to.webp' alt="img"/>
                    <p className="text-black text-center text-[24px] font-bold mt-2">Правила посещение Аль-Харам</p>
                    <ul className="ml-0 mt-2 text-[20px]">
                        <li>1) (По возможности) Сразу же идти на тавафул Масжидуль Харам на тавафул куддум</li>
                        <li className="mt-2">2) (По возможности) Входят в мечеть через ворота &quot;Бабу ссалам&quot;</li>
                        <li className="mt-2">3) При приближении к воротам мечети нужно заново покаяться</li>
                        <li className="mt-2">4) Всегда входят с правой ноги, выходят с левой (в любой мечети)</li>
                        <li className="mt-2 mb-10">5) При входе и выходе внутрь читают дуа</li>
                    </ul>
                </div>
            </ContextLink>
        </>,
    ...
    },
    {
        ...
        overview: <div className="">
            <p className="pt-4 mb-2"><span className="font-bold">Макам Ибрахима</span> (место Ибрахима) — место в пределах комплекса Мечеть аль-Харам, на
        ...
        amal: <>
            <ContextLink content={
                <>
                    <div className="flex gap-2 p-[5px] rounded-[15px]">
                        <div>
                            <p className="text-center font-bold text-[24px] mb-2">                            Чтение два ракаат намаза за макамом</p>
                            <p className="ml-6 mt-2 text-[16px]">
                                <p className="mt-4 mb-2">
                                ...
                                <p className="mb-2">
                                    Совершение намаза за макамом не должно быть именно за макамом
                                </p>
                ...
                <div>
                    <img className="rounded-[15px] w-[100%] mx-auto" src='/maqam-how-to.jpg' alt="image"/>
